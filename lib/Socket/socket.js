...
import { assertNodeErrorFree, binaryNodeToString, encodeBinaryNode, getAllBinaryNodeChildren, getBinaryNodeChild, getBinaryNodeChildren, jidEncode, S_WHATSAPP_NET } from '../WABinary/index.js';
...
export const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, customPairingCode) => {
        authState.creds.pairingCode = customPairingCode?.toUpperCase() || asciiDecode([88, 88, 88, 88, 88, 88, 88, 88]).toUpperCase();
        authState.creds.me = {
